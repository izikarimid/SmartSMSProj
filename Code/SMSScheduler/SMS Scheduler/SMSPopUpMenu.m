...
//  SMS Scheduler
//
//  Created by  Diyan Zhekov on 10/19/15.
                 ...
                 fromRect:(CGRect)fromRect
{
    ...
    const CGFloat rectY1 = fromRect.origin.y;
    const CGFloat rectYM = fromRect.origin.y;
...
- (UIView *) mkContentView
{
    ...
    for (KxMenuItem *menuItem in _menuItems) {
        ...
        if (menuItem.title.length) {
            ...
            titleLabel.textColor = [SMSColors defaultColor];
